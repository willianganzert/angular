...
# Use lf as the line ending. The //packages/bazel/test/ng_package:example_package test doesn't
# deal well with windows line endings. We should fix the test instead really.
